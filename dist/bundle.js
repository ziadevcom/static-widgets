...
(() => {
      ...
      379: (t) => {
        ...
        function a(t, a) {
          for (var s = {}, i = [], o = 0; o < t.length; o++) {
            ...
            if (-1 !== h) e[h].references++, e[h].updater(m);
              ...
              var z = l(m, a);
              (a.byIndex = o),
                e.splice(o, 0, { identifier: p, updater: z, references: 1 });
            }
            i.push(p);
          }
          return i;
        ...
        t.exports = function (t, l) {
          ...
          return function (t) {
            ...
            for (var r = a(t, l), c = 0; c < s.length; c++) {
              var d = n(s[c]);
  ...
  (() => {
          ...
          },
          {
            ...
            value: function (t) {
              for (var e = "", n = 0; n < t.length; n++)
                if (this.isNumeric(t[n]) || "," == t[n]) {
                  if (n > 0 && "," == t[n] && this.isAlphabet(t[n - 1]))
                    continue;
                  "," === t[n] ? (e += ".") : (e += t[n]);
                }
              return e;
          ...
          },
          {
            ...
            value: function (t, e) {
              for (var n = "", a = 0; a < t.length; a++)
                if (this.isNumeric(t[a]) || "." == t[a] || (e && "," == t[a])) {
                  if (a > 0 && "." == t[a] && this.isAlphabet(t[a - 1]))
                    continue;
                  n += t[a];
                }
              return n;
    ...
    (C.styleTagTransform = g()),
      (C.setAttributes = h()),
      (C.insert = d().bind(null, "head")),
      (C.domAPI = r()),
      (C.insertStyleElement = z()),
      i()(f.Z, C),
    ...
    var b = (function () {
      function t(e) {
        ...
        "french" === this.language && (this.language = "fr"),
          ("spanish" !== this.language &&
            "espanol" !== this.language &&
            "español" !== this.language) ||
            (this.language = "es"),
          (this.numberOfPayments = e.numberOfPayments || 4);
        var n = this.widgetLanguageTranslation(
            this.language,
            this.numberOfPayments,
            this.merchantLocale
          ),
          a = this.widgetLanguageTranslationLT(this.language);
        (this.widgetTemplate =
          this.getWidgetTemplateOverride(e.widgetTemplate) || n),
          (this.widgetTemplateLT =
            this.getWidgetTemplateOverride(e.widgetTemplateLT) || a),
        //   (this.ineligibleWidgetTemplate =
        //     this.getWidgetTemplateOverride(
        //       e.ineligibleWidgetTemplate.replace("%%price%%", "")
        //     ) || ""),
      ...
      return (
        ...
        (n = [
          ...
          {
            key: "getWidgetTemplateOverride",
            value: function (t) {
              return null !== t && "object" == y(t)
                ? t[this.language] || t.en
                : t;
            },
          },
          {
            ...
            value: function () {
              this.fontWeight &&
                ...
                "inherit" != this.fontSize &&
                  (this.renderElement.children[0].children[0].style.fontSize =
          ...
          },
          {
            ...
            value: function () {
              this.maxWidth &&
                (this.renderElement.children[0].children[0].style.maxWidth =
              ...
              switch (this.theme) {
                case "dark":
                  (this.imageClassName = "szl-dark-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleDark);
                  break;
                case "grayscale":
                  (this.imageClassName = "szl-light-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleGrey);
                  break;
                case "black-flat":
                  (this.imageClassName = "szl-light-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleBlack);
                  break;
                case "white":
                  (this.imageClassName = "szl-dark-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleWhite);
                  break;
                case "white-flat":
                  (this.imageClassName = "szl-dark-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleWhiteAlt);
                  break;
                case "purple-pill":
                  (this.imageClassName = "szl-light-image"),
                    (this.imageInnerHTML = l.svgImages().sezzlePurplePill);
                  break;
                case "white-pill":
                  (this.imageClassName = "szl-dark-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleWhitePill);
                  break;
                default:
                  (this.imageClassName = "szl-light-image"),
                    (this.imageInnerHTML = l.svgImages().sezzleLight);
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              (this.renderElement.style.marginTop = "".concat(
                this.marginTop,
                "px"
              )),
                (this.renderElement.style.marginBottom = "".concat(
                  this.marginBottom,
                  "px"
                )),
                (this.renderElement.style.marginLeft = "".concat(
                  this.marginLeft,
                  "px"
                )),
                (this.renderElement.style.marginRight = "".concat(
                  this.marginRight,
                  "px"
                ));
            },
          },
          {
            ...
            value: function () {
              this.scaleFactor &&
                ((this.renderElement.style.transformOrigin = "top ".concat(
                  this.alignment
                )),
                (this.renderElement.style.transform = "scale(".concat(
                  this.scaleFactor,
                  ")"
                ))),
                this.fixedHeight &&
                  ((this.renderElement.style.height = "".concat(
                    this.fixedHeight,
                    "px"
                  )),
          ...
          },
          {
            ...
            value: function () {
              this.renderElementArray.forEach(function (t, e) {
                ...
                n.innerHTML.length &&
                  n.removeChild(
                    n.querySelector(".sezzle-checkout-button-wrapper")
                  );
              });
              ...
              if (t.length)
                for (var e = t.length - 1; t.length > 0; e--)
                  t[e].parentElement.removeChild(t[e]);
            },
          },
          {
            key: "setLogoSize",
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = Object.keys(this.logoStyle), n = 0;
                n < e.length;
                n++
              )
                t.style[e[n]] = this.logoStyle[e[n]];
            },
          },
          {
            ...
            value: function () {
              ...
              (n.className = "sezzle-button-text"), this.setImageURL();
              var a = t.split("%%"),
                s = {
                  en: "Learn more",
              ...
              a.forEach(
                function (t) {
                  switch (t) {
                    case "price":
                      ...
                      e.className = "sezzle-payment-amount sezzle-button-text";
                      var a = document.createTextNode(this.getFormattedPrice());
                    ...
                    case "logo":
                      ...
                      o.setAttribute("width", "798.16"),
                        o.setAttribute("height", "199.56"),
                        o.setAttribute("viewBox", "0 0 798.16 199.56"),
                        o.setAttribute(
                          "class",
                          "sezzle-logo ".concat(this.imageClassName)
                        ),
                        o.setAttribute("aria-label", "Sezzle"),
                        (o.style.height = "18px !important"),
                        (o.innerHTML = this.imageInnerHTML),
                        n.appendChild(o),
                        this.logoStyle != {} && this.setLogoStyle(o),
                        this.setLogoSize(o),
                        ("purple-pill" !== this.theme &&
                          "white-pill" != this.theme) ||
                          (o.style.transform = "scale(12)");
                      break;
                    case "link":
                      var r = document.createElement("div");
                      (r.style.color = this.textColor),
                        (r.ariaLabel = "".concat(i[this.language], " Sezzle")),
                        (r.className =
                          "sezzle-learn-more sezzle-modal-open-link");
                      var c = document.createTextNode(s[this.language]);
                      r.appendChild(c), n.appendChild(r);
                      break;
                    case "info":
                      var d = document.createElement("div");
                      (d.ariaLabel = "".concat(i[this.language], " Sezzle")),
                        (d.className =
                    ...
                    case "question-mark":
                      ...
                      (p.role = "button"),
                        (p.type = "button"),
                        (p.ariaLabel = "".concat(i[this.language], " Sezzle"));
                      var h = document.createElementNS(
                        "http://www.w3.org/2000/svg",
                        "svg"
                      );
                      h.setAttribute("width", "14"),
                        h.setAttribute("height", "14"),
                        h.setAttribute("viewBox", "0 0 369 371"),
                        p.setAttribute(
                          "class",
                          "sezzle-question-mark-icon sezzle-modal-open-link"
                        ),
                        (h.innerHTML = l.svgImages().questionMarkIcon),
                        p.appendChild(h),
                        n.appendChild(p);
                      break;
                    case "afterpay-logo":
                      (m = document.createElementNS(
                        "http://www.w3.org/2000/svg",
                        "svg"
                      )).setAttribute("width", "115"),
                        m.setAttribute("height", "40"),
                        m.setAttribute("viewBox", "0 0 115 40"),
                        m.setAttribute(
                          "class",
                        ...
                        m.setAttribute("aria-label", "Afterpay"),
                        (m.innerHTML = l.svgImages().apNodeColor),
                        n.appendChild(m),
                        this.setLogoSize(m);
                      break;
                    case "afterpay-logo-grey":
                      (m = document.createElementNS(
                        ...
                        m.setAttribute("aria-label", "Afterpay"),
                        (m.innerHTML = l.svgImages().apNodeGrey),
                        n.appendChild(m),
                        this.setLogoSize(m);
                      break;
                    case "afterpay-logo-white":
                      ...
                      (m = document.createElementNS(
                        ...
                        m.setAttribute("aria-label", "Afterpay"),
                        (m.innerHTML = l.svgImages().apNodeWhite),
                        n.appendChild(m),
                        this.setLogoSize(m);
                      break;
                    case "afterpay-info-icon":
                      ...
                      (z.role = "button"),
                        ...
                        (z.className = "ap-modal-info-link no-sezzle-info"),
                        (z.innerHTML = "&#9432;"),
                        n.appendChild(z);
                      break;
                    case "afterpay-link-icon":
                      var u = document.createElement("a");
                      (u.href = this.apLink), (u.target = "_blank");
                      var g = document.createElement("code");
                      (g.ariaLabel = "".concat(i[this.language], " Afterpay")),
                        (g.className = "ap-info-link"),
                        (g.innerHTML = "&#9432;"),
                        u.appendChild(g),
                        n.appendChild(u);
                      break;
                    case "quadpay-logo":
                      (f = document.createElementNS(
                        "http://www.w3.org/2000/svg",
                        "svg"
                      )).setAttribute("width", "498"),
                        f.setAttribute("height", "135"),
                        f.setAttribute("viewBox", "0 0 498 135"),
                        f.setAttribute(
                          "class",
                        ...
                        f.setAttribute("aria-label", "Quadpay"),
                        (f.innerHTML = l.svgImages().qpNodeColor),
                        n.appendChild(f),
                        this.setLogoSize(f);
                      break;
                    case "quadpay-logo-grey":
                      (f = document.createElementNS(
                        ...
                        f.setAttribute("aria-label", "Quadpay"),
                        (f.innerHTML = l.svgImages().qpNodeGrey),
                        n.appendChild(f),
                        this.setLogoSize(f);
                      break;
                    case "quadpay-logo-white":
                      ...
                      (f = document.createElementNS(
                        ...
                        f.setAttribute("aria-label", "Quadpay"),
                        (f.innerHTML = l.svgImages().qpNodeWhite),
                        n.appendChild(f),
                        this.setLogoSize(f);
                      break;
                    case "quadpay-info-icon":
                      ...
                      (C.role = "button"),
                        (C.type = "button"),
                        (C.ariaLabel = "".concat(i[this.language], " Quadpay")),
                        (C.className =
                    ...
                    case "affirm-logo":
                      (y = document.createElementNS(
                        ...
                        y.setAttribute("height", "170"),
                        y.setAttribute("viewBox", "0 0 450 170"),
                        y.setAttribute(
                          "class",
                        ...
                        y.setAttribute("aria-label", "Affirm"),
                        (y.innerHTML = l.svgImages().affirmNodeColor),
                        n.appendChild(y),
                        this.setLogoSize(y);
                      break;
                    case "affirm-logo-grey":
                      (y = document.createElementNS(
                        ...
                        y.setAttribute("aria-label", "Affirm"),
                        (y.innerHTML = l.svgImages().affirmNodeGrey),
                        n.appendChild(y),
                        this.setLogoSize(y);
                      break;
                    case "affirm-logo-white":
                      ...
                      (y = document.createElementNS(
                        ...
                        y.setAttribute("aria-label", "Affirm"),
                        (y.innerHTML = l.svgImages().affirmNodeWhite),
                        n.appendChild(y),
                        this.setLogoSize(y);
                      break;
                    case "affirm-info-icon":
                      ...
                      (v.role = "button"),
                        (v.type = "button"),
                        (v.ariaLabel = "".concat(i[this.language], " Affirm")),
                        (v.className = "affirm-modal-info-link no-sezzle-info"),
                        (v.innerHTML = "&#9432;"),
                        n.appendChild(v);
                      break;
                    case "klarna-logo":
                      (b = document.createElementNS(
                        ...
                        b.setAttribute("viewBox", "0 0 45 23"),
                        b.setAttribute(
                          "class",
                        ...
                        b.setAttribute("aria-label", "Klarna"),
                        (b.innerHTML = l.svgImages().klarnaNodeColor),
                        n.appendChild(b),
                        this.setLogoSize(b);
                      break;
                    case "klarna-logo-grey":
                      (b = document.createElementNS(
                        ...
                        b.setAttribute("aria-label", "Klarna"),
                        (b.innerHTML = l.svgImages().klarnaNodeGrey),
                        n.appendChild(b),
                        this.setLogoSize(b);
                      break;
                    case "klarna-logo-white":
                      ...
                      (b = document.createElementNS(
                        ...
                        b.setAttribute("aria-label", "Klarna"),
                        (b.innerHTML = l.svgImages().klarnaNodeWhite),
                        n.appendChild(b),
                        this.setLogoSize(b);
                      break;
                    case "klarna-info-icon":
                      ...
                      (L.role = "button"),
                        (L.type = "button"),
                        (L.ariaLabel = "".concat(i[this.language], " Klarna")),
                        (L.className = "klarna-modal-info-link no-sezzle-info"),
                        (L.innerHTML = "&#9432;"),
                        n.appendChild(L);
                      break;
                    case "line-break":
                    ...
                    case "&eacute;":
                      ...
                      (k.innerHTML = "&#233;"), n.appendChild(k);
                      break;
                    case "&ecirc;":
                      var x = document.createElement("span");
                      (x.innerHTML = "&#234;"), n.appendChild(x);
                      break;
                    case "&auml;":
                      var M = document.createElement("span");
                      (M.innerHTML = "&#228;"), n.appendChild(M);
                      break;
                    case "&uuml;":
                      var S = document.createElement("span");
                      (S.innerHTML = "&#252;"), n.appendChild(S);
                      break;
                    default:
                ...
                e.appendChild(n),
                this.renderElement.appendChild(e),
                this.addCSSAlignment(),
          ...
          },
          {
            ...
            value: function (t) {
              var e =
                "default" === this.parseMode
                  ? l.parsePrice(t)
                  : l.parsePrice(t, this.parseMode);
              this.productPrice = e;
              var n = 100 * e;
              return n >= this.minPrice && n <= this.maxPrice;
            },
          },
          {
            ...
            value: function (t) {
              ...
              var n = 100 * e;
              return (
                this.minPriceLT && n >= this.minPriceLT && n <= this.maxPrice
              );
            },
          },
          {
            ...
            value: function () {
              var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : this.amount,
                e = t,
                n = l.parsePriceString(e, !0),
                a =
                  "default" === this.parseMode
                    ? l.parsePrice(e)
                    : l.parsePrice(e, this.parseMode),
                s = e.replace(n, "{price}"),
                i = this.termsToShow(a),
                o = this.isProductEligibleLT(t)
                  ? this.calculateMonthlyWithInterest(
                      a.toString(),
                      i[i.length - 1],
                      this.bestAPR
                    )
                  : a / this.numberOfPayments;
              return s.replace(
                "{price}",
                this.addDelimiters(o, this.parseMode)
              );
            },
          },
          {
            key: "addDelimiters",
            value: function (t, e) {
              var n = Number(t).toFixed(2);
              if (n.length > 6 && "comma" === e) {
                var a = n.replace(".", ",");
                return (
                  a.substring(0, a.indexOf(",") - 3) +
                  "." +
                  a.substring(a.indexOf(",") - 3, a.length)
                );
              }
              return n.length > 6
                ? n.substring(0, n.indexOf(".") - 3) +
                    "," +
                    n.substring(n.indexOf(".") - 3, n.length)
                : n;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (n > 0) {
                var l = n / 100 / 12;
                return (a * l * Math.pow(1 + l, e)) / (Math.pow(1 + l, e) - 1);
              }
              return a / e;
            },
          },
          {
            ...
            value: function (t, e, n, a) {
              var l = this.calculateMonthlyWithInterest(t, n, a);
              return this.addDelimiters(l.toFixed(2), e);
            },
          },
          {
            key: "formatTotalInterest",
            value: function (t, e, n, a) {
              var l = this.calculateMonthlyWithInterest(t, n, a) * n;
              return this.addDelimiters(l - t, e);
            },
          },
          {
            ...
            value: function (t, e, n, a) {
              var l = this.calculateMonthlyWithInterest(t, n, a);
              return this.addDelimiters(l * n, e);
            },
          },
          {
            ...
            value: function () {
              ...
              document.addEventListener("keydown", function (t) {
                if ("ArrowDown" === t.key && document.activeElement === n)
                  e.focus();
                else if ("ArrowUp" === t.key && document.activeElement === e)
                  n.focus();
                  ...
                  var s = document.querySelector("#sezzle-modal-return");
                  s
                    ? (s.focus(), s.removeAttribute("id"))
                    : document
            ...
            value: function () {
              var t = {
                en: {
                  ...
                  percent: "percent",
                  terms1:
                    'Signing up for Sezzle will not impact your credit score. You may opt-in to our free credit reporting program, Sezzle Up, to have your payments reported to credit bureaus. Learn more about spending power <a href="https://sezzle.com/how-it-works" target="_blank">here</a>.',
                  terms2:
                    'Subject to approval. <a href="https://www.sezzle.com/legal" target="_blank">Click here for complete terms.</a> First payment date and amount may fluctuate based on eligibility and time of merchant order completion.',
                  termsLt1:
                    'Signing up for Sezzle will not impact your credit score. <a href="https://sezzle.com/how-it-works" target="_blank">Learn&nbsp;more&nbsp;here.</a>',
                  termsLt2:
                    'Subject to approval. <a href="https://www.sezzle.com/legal" target="_blank">Click here for complete terms.</a> First payment date and amount may fluctuate based on eligibility and time of merchant order completion.',
                  termsLt3:
                    "Subject to credit approval by a third party lender. Rates from 5.99% - 34.99% APR; terms from 3 months – 48 months, which may vary by lender. 0% APR options may be available. APRs will vary depending on credit qualifications, loan amount, term, and lender. Minimum purchase is required.",
                },
                fr: {
                  ...
                  sezzleHeaderLt:
                    "Effectuez des paiements mensuels faciles sur votre&nbsp;achat",
                  sezzleRowChild:
                    "Plans de paiement flexibles pour votre&nbsp;budget",
                  sezzleRowLtChild:
                    "Vérifier l'éligibilité n'affectera pas votre crédit.",
                  pieAlt: "graphique circulaire à",
                  today: "Aujourd'hui",
                  week: "Semaine",
                  singleFeatureOptions: "Décision de crédit instantanée",
                  ...
                  singleFeatureTrusted:
                    "Reconnu par plus de 10 millions de&nbsp;consommateurs",
                  singleFeatureCreditBuilding:
                  ...
                  percent: "pour cent",
                  terms1:
                    "L'inscription à Sezzle n'aura aucune incidence sur votre pointage de crédit. Vous pouvez accepter de participer à notre programme gratuit d'évaluation du crédit, Sezzle Up, afin que vos paiements soient signalés aux bureaux de crédit. Pour en savoir plus sur le pouvoir d'achat, <a href=\"https://sezzle.com/how-it-works\" target=\"_blank\">cliquez ici.</a>",
                  terms2:
                    'Sous réserve d\'approbation. <a href="https://www.sezzle.com/legal" target="_blank">Cliquez ici pour l\'intégralité des conditions.</a> La date et le montant du premier paiement peuvent varier en fonction de l\'éligibilité et de la date de finalisation de la commande auprès du vendeu.',
                  termsLt1:
                    'L\'inscription à Sezzle n\'aura aucune incidence sur votre pointage de crédit. <a href="https://sezzle.com/how-it-works" target="_blank">Pour en savoir plus, cliquez ici.</a>',
                  termsLt2:
                    'Sous réserve d\'approbation. <a href="https://www.sezzle.com/legal" target="_blank">Cliquez ici pour l\'intégralité des conditions.</a> La date et le montant du premier paiement peuvent varier en fonction de l\'éligibilité et de la date de finalisation de la commande auprès du vendeu.',
                  termsLt3:
                    "Sous réserve de l'approbation du crédit par un prêteur tiers. Taux de 5,99 % à 34,99 % APR ; durées de 3 mois à 48 mois, qui peuvent varier selon le prêteur. Des options à 0 % APR peuvent être disponibles. Les APR varient en fonction des qualifications de crédit, du montant du prêt, de la durée et du prêteur. Un achat minimum est requis.",
                },
                es: {
                  ...
                  sezzleHeaderChild:
                    "Paga en 4 seleccionando Sezzle al finalizar la&nbsp;compra.",
                  sezzleHeaderLt:
                    "Realiza pagos mensuales fáciles en tu compra",
                  sezzleRowChild:
                    "Planes de pago flexibles para su&nbsp;presupuesto",
                  sezzleRowLtChild:
                    "Verificar la elegibilidad no afectará su crédito.",
                  pieAlt: "gráfico circular en",
                  today: "Hoy",
                  week: "Semana",
                  singleFeatureOptions: "Decisión de crédito instantánea",
                  singleFeatureCredit:
                  ...
                  singleFeatureTrusted:
                    "Con la confianza de más de 10 millones de consumidores",
                  singleFeatureCreditBuilding:
                    "Optar por informes de crédito&nbsp;gratis",
                  ...
                  percent: "por ciento",
                  terms1:
                    'Registrarse en Sezzle no afectará su puntaje de crédito. Puede aceptar participar en nuestro programa gratuito de informes crediticios, Sezzle Up, para que sus pagos sean informados a las agencias de crédito. Para obtener más información sobre el poder adquisitivo, <a href="https://sezzle.com/how-it-works" target="_blank">haga clic aquí.</a>',
                  terms2:
                    'Sujeto a aprobación. <a href="https://www.sezzle.com/legal" target="_blank">Haga clic aquí para ver los términos completos.</a> La fecha y el monto del primer pago pueden variar según la elegibilidad y la fecha de finalización del pedido con el&nbsp;vendedor.',
                  termsLt1:
                    'Registrarse en Sezzle no afectará su puntaje de crédito. <a href="https://sezzle.com/how-it-works" target="_blank">Para obtener más información, haga clic aquí.</a>',
                  termsLt2:
                    'Sujeto a aprobación. <a href="https://www.sezzle.com/legal" target="_blank">Haga clic aquí para ver los términos completos.</a> La fecha y el monto del primer pago pueden variar según la elegibilidad y la fecha de finalización del pedido con el&nbsp;vendedor.',
                  termsLt3:
                    "Sujeto a la aprobación de crédito por parte de un tercero prestamista. Tasas desde 5,99% - 34,99% TAE; plazos de 3 meses a 48 meses, que pueden variar según el prestamista. Las opciones de 0% APR pueden estar disponibles. Las APR variarán según las calificaciones crediticias, el monto del préstamo, el plazo y el prestamista. Se requiere compra mínima.",
                },
              };
              if (
                ...
                if (
                  ...
                  (e.ariaLabel = t[this.language].sezzleInfo),
                  (e.ariaDescription = t[this.language].aboutSezzle),
                  this.isProductEligibleLT(this.amount))
                ) {
                  var n = String.fromCharCode(this.currencySymbol(this.amount)),
                    a =
                      this.amount.indexOf(n) > -1
                        ? this.amount.split(n)[1]
                        : this.amount;
                  a =
                    "comma" === this.parseMode
                      ? a.replace(".", "").replace(",", ".")
                      : a.replace(",", "");
                  var l = this.termsToShow(a);
                  this.ltAltModalHTML
                    ? (e.innerHTML = this.ltAltModalHTML)
                    : (e.innerHTML =
                        '\n\t\t\t\t<div id="sezzle-modal-container" role="dialog" aria-label="Sezzle Modal" aria-description="'
                          .concat(
                            t[this.language].aboutSezzle,
                          ...
                          .concat(
                            t[this.language].sezzleHeaderLt,
                            '</header>\n\t\t\t\t\t\t\t<div class="sezzle-row">'
                          )
                          .concat(
                            t[this.language].sezzleRowLtChild,
                            '</div>\n\t\t\t\t\t\t\t<div class="sezzle-lt-payments">\n\t\t\t\t\t\t\t\t<div class="sezzle-lt-payment-header">'
                          )
                          .concat(
                            t[this.language].sezzleLtPaymentHeader,
                            " <span>"
                          )
                          .concat(
                            n + this.addDelimiters(a, this.parseMode),
                          ...
                          .concat(
                            t[this.language].singleFeatureAffordable,
                            '</div>\n\t\t\t\t\t\t\t<div class="details">'
                          )
                          .concat(
                            t[this.language].singleFeaturePrequalify,
                            '</div>\n\t\t\t\t\t\t\t<div class="details">'
                          )
                          .concat(
                            t[this.language].singleFeatureTrusted,
                            '</div>\n\t\t\t\t\t\t\t<div class="terms">\n\t\t\t\t\t\t\t\t<p>'
                          )
                          .concat(
                            t[this.language].termsLt1,
                            "</p>\n\t\t\t\t\t\t\t\t<p>"
                          )
                          .concat(
                            t[this.language].termsLt2,
                            "</p>\n\t\t\t\t\t\t\t\t<p>"
                          )
                          .concat(
                            t[this.language].termsLt3,
                            "</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>"
                          ));
                } else
                  this.altModalHTML
                    ...
                    : (e.innerHTML =
                        '\n        <div id="sezzle-modal-container" role="dialog" aria-label="Sezzle Modal" aria-description="'
                          ...
                          .concat(
                            t[this.language].sezzleRowChild,
                            '\n\t\t\t\t\t</p>\n\t\t\t\t\t<div class="sezzle-pie-area">\n\t\t\t\t\t\t<div class="due-today">\n\t\t\t\t\t\t\t<div class="payment-item">\n\t\t\t\t\t\t\t\t<div title="'
                          )
                          .concat(
                            t[this.language].pieAlt,
                          ...
                          .concat(
                            t[this.language].singleFeatureOptions,
                            '\n\t\t\t\t\t\t\t</p>\n\t\t\t\t\t\t\t<p class="single-feature">\n\t\t\t\t\t\t\t\t'
                          )
                          .concat(
                            t[this.language].singleFeatureCreditBuilding,
                            '\n\t\t\t\t\t\t\t</p>\n        \t\t\t\t</div>\n        \t\t\t<p class="terms">'
                          )
                          .concat(
                            t[this.language].terms1,
                            '</p>\n        \t\t\t<p class="terms">'
                          )
                          .concat(
                            t[this.language].terms2,
                            "</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>"
                          ));
              ...
              Array.prototype.forEach.call(
                ...
                function (t) {
                  t.addEventListener("click", function () {
                    (e.style.display = "none"),
                      (e.getElementsByClassName("sezzle-modal")[0].className =
                        "sezzle-modal sezzle-modal".concat(
                          "grayscale" === this.modalTheme
                            ? "-grayscale"
                            : "-color",
              ...
              var s = document.getElementsByClassName("sezzle-modal")[0];
              s ||
          ...
          },
          {
            ...
            value: function () {
              ...
              (t.className =
                ...
                (t.ariaDescription = "Click to learn more about Afterpay"),
          ...
          },
          {
            ...
            value: function () {
              ...
              (t.className =
                ...
                (t.ariaDescription = "Click to learn more about Quadpay"),
          ...
          },
          {
            ...
            value: function () {
              ...
              (t.className =
                ...
                (t.ariaDescription = "Click to learn more about Affirm"),
          ...
          },
          {
            ...
            value: function () {
              ...
              (t.className =
                ...
                (t.ariaDescription = "Click to learn more about Klarna"),
          ...
          },
          {
            ...
            value: function () {
              ...
              (t.style.display = "block"),
                (t.getElementsByClassName("sezzle-modal")[0].className =
                  "sezzle-modal sezzle-modal".concat(
          ...
          },
          {
            ...
            value: function (t) {
              var e = document.getElementsByClassName("sezzle-modal-link");
              Array.prototype.forEach.call(
                e,
                function (t) {
                  t.addEventListener(
                    ...
                    function (t) {
                      if (
                        (t.preventDefault(),
                        !t.target.classList.contains("no-sezzle-info"))
                      ) {
                        ...
                        (e.style.display = "block"),
                          ...
                          (e.getElementsByClassName(
                            "sezzle-modal"
                          )[0].className = "sezzle-modal sezzle-modal".concat(
                            "grayscale" === this.modalTheme
                              ? "-grayscale"
                              : "-color"
                          )),
              ...
              var n = t.getElementsByClassName("ap-modal-info-link");
              Array.prototype.forEach.call(
                n,
                function (t) {
                  t.addEventListener(
              ...
              var a = t.getElementsByClassName("quadpay-modal-info-link");
              Array.prototype.forEach.call(
                a,
                function (t) {
                  t.addEventListener(
              ...
              var l = t.getElementsByClassName("affirm-modal-info-link");
              Array.prototype.forEach.call(
                l,
                function (t) {
                  t.addEventListener(
              ...
              var s = t.getElementsByClassName("klarna-modal-info-link");
              Array.prototype.forEach.call(
                s,
                function (t) {
                  t.addEventListener(
          ...
          },
          {
            ...
            value: function () {
              var t = [];
              (function () {
                this.renderElementArray.forEach(function (e, n) {
                ...
                function () {
                  this.renderModal(),
                    document.getElementsByClassName("ap-modal-info-link")
                      .length > 0 && this.renderAPModal(),
                    document.getElementsByClassName("quadpay-modal-info-link")
                      .length > 0 && this.renderQPModal(),
                    document.getElementsByClassName("affirm-modal-info-link")
                      .length > 0 && this.renderAffirmModal(),
                    document.getElementsByClassName("klarna-modal-info-link")
                      .length > 0 && this.renderKlarnaModal();
                }.call(this);
            },
          },
        ]),
